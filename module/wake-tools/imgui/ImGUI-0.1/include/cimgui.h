...
#include "vectype.h"
#ifndef __cplusplus
typedef  vec2 ImVec2;typedef  vec4 ImVec4;
#endif
...
CIMGUI_API ImColor ImColor_HSV(float h,float s,float v,float a);
...
CIMGUI_API ImVec2 ImGuiViewport_GetCenter(ImGuiViewport* self);
CIMGUI_API ImVec2 ImGuiViewport_GetWorkCenter(ImGuiViewport* self);
...
CIMGUI_API ImVec2 igImMin(const ImVec2 lhs,const ImVec2 rhs);
CIMGUI_API ImVec2 igImMax(const ImVec2 lhs,const ImVec2 rhs);
CIMGUI_API ImVec2 igImClamp(const ImVec2 v,const ImVec2 mn,ImVec2 mx);
CIMGUI_API ImVec2 igImLerp_Vec2Float(const ImVec2 a,const ImVec2 b,float t);
CIMGUI_API ImVec2 igImLerp_Vec2Vec2(const ImVec2 a,const ImVec2 b,const ImVec2 t);
CIMGUI_API ImVec4 igImLerp_Vec4(const ImVec4 a,const ImVec4 b,float t);
...
CIMGUI_API ImVec2 igImFloor_Vec2(const ImVec2 v);
CIMGUI_API ImVec2 igImFloorSigned_Vec2(const ImVec2 v);
CIMGUI_API int igImModPositive(int a,int b);
CIMGUI_API float igImDot(const ImVec2 a,const ImVec2 b);
CIMGUI_API ImVec2 igImRotate(const ImVec2 v,float cos_a,float sin_a);
CIMGUI_API float igImLinearSweep(float current,float target,float speed);
CIMGUI_API ImVec2 igImMul(const ImVec2 lhs,const ImVec2 rhs);
CIMGUI_API bool igImIsFloatAboveGuaranteedIntegerPrecision(float f);
CIMGUI_API ImVec2 igImBezierCubicCalc(const ImVec2 p1,const ImVec2 p2,const ImVec2 p3,const ImVec2 p4,float t);
CIMGUI_API ImVec2 igImBezierCubicClosestPoint(const ImVec2 p1,const ImVec2 p2,const ImVec2 p3,const ImVec2 p4,const ImVec2 p,int num_segments);
CIMGUI_API ImVec2 igImBezierCubicClosestPointCasteljau(const ImVec2 p1,const ImVec2 p2,const ImVec2 p3,const ImVec2 p4,const ImVec2 p,float tess_tol);
CIMGUI_API ImVec2 igImBezierQuadraticCalc(const ImVec2 p1,const ImVec2 p2,const ImVec2 p3,float t);
CIMGUI_API ImVec2 igImLineClosestPoint(const ImVec2 a,const ImVec2 b,const ImVec2 p);
CIMGUI_API bool igImTriangleContainsPoint(const ImVec2 a,const ImVec2 b,const ImVec2 c,const ImVec2 p);
CIMGUI_API ImVec2 igImTriangleClosestPoint(const ImVec2 a,const ImVec2 b,const ImVec2 c,const ImVec2 p);
...
CIMGUI_API ImRect* ImRect_ImRect(void);
...
CIMGUI_API ImVec2 ImRect_GetCenter(ImRect* self);
CIMGUI_API ImVec2 ImRect_GetSize(ImRect* self);
...
CIMGUI_API ImVec2 ImRect_GetTL(ImRect* self);
CIMGUI_API ImVec2 ImRect_GetTR(ImRect* self);
CIMGUI_API ImVec2 ImRect_GetBL(ImRect* self);
CIMGUI_API ImVec2 ImRect_GetBR(ImRect* self);
...
CIMGUI_API ImVec4 ImRect_ToVec4(ImRect* self);
...
CIMGUI_API ImRect ImGuiDockNode_Rect(ImGuiDockNode* self);
...
CIMGUI_API ImVec2 ImGuiViewportP_CalcWorkRectPos(ImGuiViewportP* self,const ImVec2 off_min);
CIMGUI_API ImVec2 ImGuiViewportP_CalcWorkRectSize(ImGuiViewportP* self,const ImVec2 off_min,const ImVec2 off_max);
CIMGUI_API void ImGuiViewportP_UpdateWorkRect(ImGuiViewportP* self);
CIMGUI_API ImRect ImGuiViewportP_GetMainRect(ImGuiViewportP* self);
CIMGUI_API ImRect ImGuiViewportP_GetWorkRect(ImGuiViewportP* self);
CIMGUI_API ImRect ImGuiViewportP_GetBuildWorkRect(ImGuiViewportP* self);
...
CIMGUI_API ImRect igWindowRectAbsToRel(ImGuiWindow* window,const ImRect r);
CIMGUI_API ImRect igWindowRectRelToAbs(ImGuiWindow* window,const ImRect r);
...
CIMGUI_API ImVec2 igScrollToRectEx(ImGuiWindow* window,const ImRect rect,ImGuiScrollFlags flags);
...
CIMGUI_API ImVec2 igGetContentRegionMaxAbs(void);
...
CIMGUI_API ImVec2 igFindBestWindowPosForPopupEx(const ImVec2 ref_pos,const ImVec2 size,ImGuiDir* last_dir,const ImRect r_outer,const ImRect r_avoid,ImGuiPopupPositionPolicy policy);
...
CIMGUI_API ImVec2 igGetKeyVector2d(ImGuiKey key_left,ImGuiKey key_right,ImGuiKey key_up,ImGuiKey key_down);
...
CIMGUI_API ImVec2 igTabItemCalcSize_Str(const char* label,bool has_close_button_or_unsaved_marker);
CIMGUI_API ImVec2 igTabItemCalcSize_WindowPtr(ImGuiWindow* window);
