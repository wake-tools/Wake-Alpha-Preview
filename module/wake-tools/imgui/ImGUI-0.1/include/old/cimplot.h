...
CIMGUI_API ImPlotPoint ImPlotRect_Size(ImPlotRect* self);
CIMGUI_API ImPlotPoint ImPlotRect_Clamp_PlotPoInt(ImPlotRect* self,const ImPlotPoint p);
CIMGUI_API ImPlotPoint ImPlotRect_Clamp_double(ImPlotRect* self,double x,double y);
CIMGUI_API ImPlotPoint ImPlotRect_Min(ImPlotRect* self);
CIMGUI_API ImPlotPoint ImPlotRect_Max(ImPlotRect* self);
...
CIMGUI_API ImPlotPoint ImPlot_PixelsToPlot_Vec2(const ImVec2 pix,ImAxis x_axis,ImAxis y_axis);
CIMGUI_API ImPlotPoint ImPlot_PixelsToPlot_Float(float x,float y,ImAxis x_axis,ImAxis y_axis);
CIMGUI_API ImVec2 ImPlot_PlotToPixels_PlotPoInt(const ImPlotPoint plt,ImAxis x_axis,ImAxis y_axis);
